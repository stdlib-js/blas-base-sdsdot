...
```javascript
sdsdot = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-sdsdot@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-sdsdot@umd/bundle.js"></script>
```
